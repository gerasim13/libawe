...
public:
    /** Output interface constructor
     *  \param sampling_rate Output sampling rate.
     *  \param op_frame_rate Output frame rate.
     *                       This sets the number of frames of audio data to
     *                       process for every call to `update()`.
     *  \param device_type   PortAudio output device type to use for audio
     *                       output.
     */
    AEngine(
