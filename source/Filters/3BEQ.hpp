...
{
private:
    double mSF; //!< Sampling frequency.
    double mLF; //!< Low-pass frequency.
    double mHF; //!< High-pass frequency.

    IIR::IIR< Channels > mLP; //!< Low-pass IIR object.
    IIR::IIR< Channels > mHP; //!< High-pass IIR object.

    double mLG; //!< Low-band gain.
    double mMG; //!< Middle-band gain.
    double mHG; //!< High-band gain.
